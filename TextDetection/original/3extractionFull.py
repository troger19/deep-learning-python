...
pixelThreshold=500 # use for comparision if checkbox is checked or not.. its number of pixel in the square, if its not check then its 0
...
for j,y in enumerate(myPicList):
    ...
    for x,r in enumerate(roi):
        ...
        if r[2] == 'text':
            ...
            ## extract check box, if its checked or not
        if r[2] =='box':
